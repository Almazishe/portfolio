# Generated by Django 3.1.4 on 2021-01-13 07:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='accounts/images/', verbose_name='User image')),
                ('birth_at', models.DateField(null=True, verbose_name='Birthday')),
                ('sex', models.CharField(choices=[('MALE', 'Male'), ('FEMALE', 'Male')], default='MALE', max_length=10, verbose_name='Sex')),
